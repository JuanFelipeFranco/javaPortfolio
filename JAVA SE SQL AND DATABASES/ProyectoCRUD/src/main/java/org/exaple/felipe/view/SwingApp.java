...
public class SwingApp extends JFrame {
    ...
    private final JTable employeeTable; //muestra los datos en forma detabla
    ...
    private void refreshEmployeeTable(){
        ...
        try{
            ...
            //establece el modelo de tabla actualizada
        ...
        if(empleadoIdStr != null){
            try {
                ...
                if (empleado != null) {
                    ...
                    JOptionPane.showMessageDialog(this,"No se encontro ningún empleado con el ID especificado","Error",JOptionPane.ERROR_MESSAGE);
                }
            }catch (NumberFormatException e){
                JOptionPane.showMessageDialog(this,"Ingrese un valor numerico valido para el ID", "Error", JOptionPane.ERROR_MESSAGE);
            }catch (SQLException e){
    ...
    private void eliminarEmpleado(){
        ...
        if (empleadoIdStr != null) {
            try{
                ...
                //Confirmar la eliminacion del empleado
                int confirmResult = JOptionPane.showConfirmDialog(this,"¿Esta seguro de eliminar el empleado?","Confirmar Eliminacion",JOptionPane.YES_NO_OPTION);
                ...
                JOptionPane.showMessageDialog(this,"Ingrese un valor numerico valido para el ID del empleado","Error",JOptionPane.ERROR_MESSAGE);
            } catch (SQLException e){
